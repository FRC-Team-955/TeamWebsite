        ...
        <div class="subpageBox">
            <div class="row crossScreenImg" id="FIRST"> <!-- set background image by css with the linking id -->
                ...
                <section class="col-md-8 .col-md-offset-2">
                    <a href="http://www.usfirst.org/roboticsprograms/frc" class="img-circle logoImg col-xs-4 col-sm-4 col-md-4" target="_blank"><img src="../images/brands/FRCicon.png" alt="FIRST Robotics Competition"></a>
                    <a href="http://www.usfirst.org/roboticsprograms/ftc" class="img-circle logoImg col-xs-4 col-sm-4 col-md-4" target="_blank"><img src="../images/brands/FTCicon.png" alt="FIRST Tech Challenge"></a>
                    <a href="http://www.usfirst.org/roboticsprograms/fll" class="img-circle logoImg col-xs-4 col-sm-4 col-md-4" target="_blank"><img src="../images/brands/FLLicon.png" alt="FIRST Lego League"></a>
                    <br/>
