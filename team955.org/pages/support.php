  ...
  Donations given through this method should specify CV Robotics on the online form.</div>
          ...
          <div class="row">
            ...
            <section class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
              ...
              <q>Robotics goes beyond friendship - we're an extended family. We meet people with the same interests and we learn from each other - and it's fun. We learn how to pull it all together to build something REAL and compete in an awesome event. What's not to love about Robotics?
-Aaron Celeste, Class of 2015</q>
            </section>
          </div>
          <div class="row">
          ...
          <div class="row">
            <section class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                <object data="../images/donateButton.svg" type="image/svg+xml" class="fullW"><a href="http://cpsfoundation.org" class="noB" target="_blank">Donate Here!</a></object>
            </section>
            <section class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
			...
			<div class="row">
			  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			    <a href="http://www.autodesk.com/">
				  <img src="../images/brands/AutodeskColor.svg" alt="Autodesk" class="fullW noB"/>
				</a>
			  </div>
			</div>
			<div class="row">
			  <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
			    <a href="http://www.tunnelradio.com/">
				  <img src="../images/brands/Tunnel_Radio.svg" alt="Tunnel Radio" class="fullW noB"/>
			    </a>
		      </div>
			  <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
			    <a href="http://www.cganodize.com/">
				  <img src="../images/brands/" alt="CG Industries" class="fullW noB"/>
				</a>
			  </div>
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
				  <a href="http://www.cpi.coop/">
				    <img src="../images/brands/CPI.svg" alt="CPI" class="fullW noB"/>
				  </a>
				</div>
			  </div>
			  <div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				  <a href="http://www.triaxiseng.com/">
				    <img src="../images/brands/TriAxis.svg" alt="Triaxiseng" class="fullW noB"/>
				  </a>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				  <a href="http://www.korvis.com/home/">
				    <img src="../images/brands/Korvis.svg" alt="Korvis" class="fullW noB"/>
				  </a>
				</div>
			  </div>
			  <div class="row">    
