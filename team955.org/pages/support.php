              ...
              <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <a href="../images/CAD/4in%20FANCY%20wheel%20assemb.SLDASM" download="FancyWheel.SLDASM">
                        <img border="0" src="../images/CAD/cad_placeholder.jpg" alt="FancyWheel" width="200" height="250">
                    </a>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <a href="../images/CAD/4in%20wheel%20part1.SLDPRT" download="WheelPart1.SLDPRT">
                        <img border="0" src="../images/CAD/cad_placeholder.jpg" alt="WheelCAD" width="200" height="250">
                    </a>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <a href="../images/CAD/Button%20Head%205-8%2010-32%20Screw.SLDPRT" download="ButtonHeadScrew.SLDPRT">
                        <img border="0" src="../images/CAD/cad_placeholder.jpg" alt="Screwhead" width="200" height="250">
                    </a>
                </div>
              </div>
            </div>
