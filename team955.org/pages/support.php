...
-Aaron Celeste, Class of 2015</q>
          ...
          <div class="row">
            <section class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                <a href="http://cpsfoundation.org" class="noB" style="display: inline-block;" target="_blank"><object data="../images/donateButton.svg" type="image/svg+xml" class="fullW" style="pointer-events: none;">Donate Here!</object></a>
            </section>
            <section class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
